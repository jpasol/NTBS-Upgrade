...
Dim prmChkValidCYM As ADODB.Parameter
    ...
    With cmdChkValidCYM
        ...
        ' set parameters then execute
        Set prmChkValidCYM = .CreateParameter("RETURN_VALUE", adInteger, adParamReturnValue)
        .Parameters.Append prmChkValidCYM
        Set prmChkValidCYM = .CreateParameter(, adChar, adParamInput, 10, pUser)
        .Parameters.Append prmChkValidCYM
        Set prmChkValidCYM = .CreateParameter("pCYMNUM", adNumeric, adParamInput, , pCYM)
        .Parameters.Append prmChkValidCYM
        .Execute
        gzChkValidCYM = .Parameters("RETURN_VALUE")
    End With
