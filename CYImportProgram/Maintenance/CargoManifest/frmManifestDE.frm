...
Begin VB.Form frmManifestDE 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmbSize 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmManifestDE.frx":000C
         Left            =   2400
         List            =   "frmManifestDE.frx":0019
         TabIndex        =   12
         Text            =   "[Select size]"
         Top             =   2160
         Width           =   2295
      ...
      Begin VB.ComboBox cmbType 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "frmManifestDE.frx":0029
         Left            =   2400
         List            =   "frmManifestDE.frx":0039
         TabIndex        =   11
         Text            =   "[Select type]"
         Top             =   1560
         Width           =   2295
...
Private Sub cmdSave_Click()
    ...
    If Trim(txtBillNo.Text) = "" Or Trim(txtCarrier.Text) = "" Or Trim(txtVesselName.Text) = "" Or Trim(txtRegistryNo.Text) = "" Or Trim(txtVoyageNo.Text) = "" Or Trim(txtConsignee.Text) = "" & _
        ...
        If flxgrdConNo.Rows >= 2 Then
            Do While flxgrdConNo.Rows > intSavingCntr + 1
                ...
                With rstManifestDet
                    ...
                    .Fields("silnum") = Trim(strSealNo)
                    .Fields("regnum") = txtRegistryNo.Text
                    If Trim(flxgrdConNo.TextMatrix(flxgrdConNo.Row, 4)) <> "" Then
                        .Fields("gpsnum") = flxgrdConNo.TextMatrix(flxgrdConNo.Row, 4)
                    End If
                    .Fields("sysdte") = gzGetSysDate
                    .Fields("userid") = zCurrentUser
                    .Update
...
Private Sub flxgrdConNo_Click()
    ...
    If flxgrdConNo.TextMatrix(flxgrdConNo.RowSel, 4) <> "" Then
...
Private Sub Format_flxgrdConNo()
    With flxgrdConNo
        ...
        .Col = 1: .Text = "Seal No.": .FontWidth = 7: .ColWidth(1) = 2000
        .Col = 2: .Text = "Type": .FontWidth = 7:  .ColWidth(2) = 2000
        .Col = 3: .Text = "Size": .FontWidth = 7: .ColWidth(3) = 1000
        .Col = 4: .Text = "Gatepass No.": .FontWidth = 7: .ColWidth(4) = 2000
    End With
End Sub
...
Private Sub RetrieveRecords()
    ...
    With rstManifestHead
        ...
        txtCarrier.Text = Trim(.Fields("carcde"))
    ...
    If Not rstManifest2.BOF Then
        Do
            With flxgrdConNo
                ...
                .Col = 1: .Text = rstManifest2.Fields("silnum")
