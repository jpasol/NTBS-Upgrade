...
Private Sub Text1_KeyPress(KeyAscii As Integer)
    ...
    If KeyAscii <> 8 Then
        If KeyAscii > 47 And KeyAscii < 58 Then
            If Text1.SelLength = 5 And (KeyAscii >= 48 And KeyAscii <= 57) Then
                Exit Sub
            End If
            If (Len(Text1.Text) = 5) Or (Not KeyAscii >= 48 And Not KeyAscii <= 57) Then
                KeyAscii = 0
                Beep
            End If
    ...
    If KeyCode <> 8 And ((KeyCode < 58 And KeyCode > 47) Or (KeyCode < 106 And KeyCode > 95)) Then
        ...
        Else
            If Len(Trim(Text1.Text)) = 2 Then
                Text1.Text = Mid(Trim(Text1.Text), 1, 1) & ":" & Mid(Trim(Text1.Text), 2, 2)
                Text1.SelStart = 2
            Else
                If Len(Trim(Text1.Text)) = 3 Then
                    Text1.Text = Mid(Trim(Text1.Text), 1, 1) & Mid(Trim(Text1.Text), 3, 2)
                    Text1.Text = Mid(Trim(Text1.Text), 1, 2) & ":" & Mid(Trim(Text1.Text), 4, 1)
                    Text1.SelStart = 3
                End If
            End If
        End If
