...
#End Region
    ...
    Private Sub ValidateUser()
        ...
        IsValidUser = clsINVCorrection.ValidateUser()

        Cursor = Cursors.Default

        If IsValidUser = True Then
            Dim frmINVCorrection As New frmINVCorrection
            frmINVCorrection.Show()
            Me.Hide()
        Else
            MsgBox("A C C E S S  D E N I E D", MsgBoxStyle.Critical, "INVOICE CORRECTION")
            End
        End If
    End Sub
